...
We  see that analyzing previous time data using diffusion maps captures the simulated four and half laps taken by the animal around the circular track while PCA  fails miserably on the same data set.  Figure \ref{fig:DiffMaps_PCA_on_Prevtime_FR}
shows our results on synthetic data. 
